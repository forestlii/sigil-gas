...
// 战斗系统设置：项目级可配的战斗开关（对齐 UE GCS_CombatSystemSettings / UDeveloperSettings）。
...
namespace Likeon.GAS
{
    ...
    /// 对齐 UE GCS_CombatSystemSettings 的两个字段。
    /// </summary>
    ...
    public class CombatSettings : ScriptableObject
    {
        ...
        [Tooltip("禁用归属（敌我）检查——调试用，允许跨队伍伤害（对齐 UE bDisableAffiliationCheck）")]
